...
GB_TIMELOCK_ADDRESS = "0x87F005317692D05BAA4193AB0c961c69e175f45f"  # T Treasury stored here
...
def main(request):
    ...
    t_treasury_supply = t_token_contract.functions.balanceOf(GB_TIMELOCK_ADDRESS).call()
